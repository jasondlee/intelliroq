...
class ShowRoqHelpAction : AnAction() {
    ...
    override fun actionPerformed(e: AnActionEvent) {
        ...
        val helpText = """
            ...
            <p><a href="https://github.com/jasondlee/roq-idea">roq-idea Plugin on GitHub</a></p>

            <h3>Support</h3>
            <p>Report issues: <a href="https://github.com/jasondlee/roq-idea/issues">GitHub Issues</a></p>
            </body>
            </html>
        """.trimIndent()
