...
class InitializeRoqProjectAction : AnAction() {
    ...
    private fun initializeRoqStructure(project: Project) {
        ...
        WriteCommandAction.runWriteCommandAction(project) {
            ...
            com.steeplesoft.intelliroq.wizard.RoqProjectInitializer.createDirectoryStructure(baseDir)

            // Create sample files
            com.steeplesoft.intelliroq.wizard.RoqProjectInitializer.createSampleFiles(baseDir, siteUrl)

            // Create or update application.properties
            com.steeplesoft.intelliroq.wizard.RoqProjectInitializer.createApplicationProperties(baseDir, siteUrl)
